...
COLDSTARTDATE=20220221000 # calendar year month day hour YYYYMMDDHH24
...
ADCIRCDIR=/jet/home/mbilskie/src/adcirc/adcirc-cg-55.01-install/bin  # ADCIRC executables
SWANDIR=/jet/home/mbilskie/src/adcirc/adcirc-cg-55.01-install/bin    # SWAN executables
SCRIPTDIR=/jet/home/mbilskie/repo/asgs    # ASGS executables
...
POST_INIT_LIST=null
POST_LIST=null
JOB_FAILED_LIST="mbilskie@uga.edu"
NOTIFYUSER=mbilskie@uga.edu
ASGSADMIN=mbilskie@uga.edu
...
TARGET=bridges2 # used in post processing to pick up HPC platform config
